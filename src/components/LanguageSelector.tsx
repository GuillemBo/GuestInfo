...
const languages: Language[] = [
  { code: 'en', label: 'English', flag: '/images/flags/england.png' },
  { code: 'es', label: 'Español', flag: '/images/flags/spain.png' },
  { code: 'fr', label: 'Français', flag: '/images/flags/france.png' },
];
